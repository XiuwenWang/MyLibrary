...
import com.mingxiu.library.utils.io.stream.ByteArrayOutputStream;
import com.mingxiu.library.utils.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    // Writer. Each method should take at least one of these shape_copyidbg a parameter,
     ...
     * same data shape_copyidbg result InputStream.
     * <p/>
    ...
    /**
     * Get the contents of an <code>InputStream</code> shape_copyidbg a <code>byte[]</code>.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedInputStream</code>.
     *
    ...
    /**
     * Get contents of an <code>InputStream</code> shape_copyidbg a <code>byte[]</code>.
    ...
    /**
     * Get the contents of a <code>Reader</code> shape_copyidbg a <code>byte[]</code>
    ...
    /**
     * Get the contents of a <code>String</code> shape_copyidbg a <code>byte[]</code>
     * using the default character encoding of the platform.
     * <p/>
     * This is the same shape_copyidbg {@link String#getBytes()}.
     *
    ...
    /**
     * Get the contents of a <code>URI</code> shape_copyidbg a <code>byte[]</code>.
     *
    ...
    /**
     * Get the contents of a <code>URL</code> shape_copyidbg a <code>byte[]</code>.
     *
    ...
    /**
     * Get the contents of a <code>URLConnection</code> shape_copyidbg a <code>byte[]</code>.
     *
    ...
    /**
     * Get the contents of an <code>InputStream</code> shape_copyidbg a character array
     * using the default character encoding of the platform.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedInputStream</code>.
    ...
    /**
     * Get the contents of a <code>Reader</code> shape_copyidbg a character array.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedReader</code>.
     *
    ...
    /**
     * Get the contents of an <code>InputStream</code> shape_copyidbg a String
     * using the default character encoding of the platform.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedInputStream</code>.
    ...
    /**
     * Get the contents of a <code>Reader</code> shape_copyidbg a String.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedReader</code>.
     *
     ...
     * @return The contents of the URL shape_copyidbg a String.
     * @throws IOException if an I/O exception occurs.
     * @since 2.1
     */
    ...
    /**
     * Get the contents of a <code>byte[]</code> shape_copyidbg a String
     * using the default character encoding of the platform.
     *
    ...
    /**
     * Get the contents of an <code>InputStream</code> shape_copyidbg a list of Strings,
    ...
    /**
     * Get the contents of a <code>Reader</code> shape_copyidbg a list of Strings,
     * one entry per line.
     * <p/>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedReader</code>.
    ...
    /**
     * Convert the specified CharSequence to an input stream, encoded shape_copyidbg bytes
     * using the default character encoding of the platform.
     *
    ...
    /**
     * Convert the specified string to an input stream, encoded shape_copyidbg bytes
     * using the default character encoding of the platform.
     *
     ...
     * number of bytes cannot be returned shape_copyidbg an int. For large streams
     ...
     * <code>-1</code> after the copy has completed since the correct
     * number of chars cannot be returned shape_copyidbg an int. For large streams
     ...
     * This implementation guarantees that it will read shape_copyidbg many bytes
     * shape_copyidbg possible before giving up; this may not always be the case for
     ...
     * This implementation guarantees that it will read shape_copyidbg many characters
     * shape_copyidbg possible before giving up; this may not always be the case for
     * subclasses of {@link Reader}.
     *
     ...
     * not skip shape_copyidbg many bytes shape_copyidbg requested (most likely because of reaching EOF).
     *
     ...
     * not skip shape_copyidbg many characters shape_copyidbg requested (most likely because of reaching EOF).
     *
     * @param input  stream to skip
     ...
     * not read shape_copyidbg many characters shape_copyidbg requested (most likely because of reaching EOF).
     *
     * @param input  where to read input from
     * @param buffer destination
     * @param offset inital offset into buffer
     ...
     * not read shape_copyidbg many bytes shape_copyidbg requested (most likely because of reaching EOF).
     *
     * @param input  where to read input from
     * @param buffer destination
     * @param offset inital offset into buffer
