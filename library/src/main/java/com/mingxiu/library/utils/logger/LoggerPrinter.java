package com.mingxiu.library.utils.logger;
...
public final class LoggerPrinter implements Printer {
     ...
     * so 4000 bytes is used shape_copyidbg chunk size since default charset
     * is UTF-8
     */
    ...
    /**
     * It is used to determine log settings such shape_copyidbg method count, thread info visibility
     */
